  ...
  return {
    ...
    dynamicSportsText: Array.isArray(dynSportsBeats)
      ? dynSportsBeats.map(o => (o && typeof o === 'object')
          ? { label: clean(o.label) || '', whatHappened: clean(o.whatHappened) || '', whyItMatters: clean(o.whyItMatters) || '', theRead: clean(o.theRead) || '', ammo: Array.isArray(o.ammo) ? o.ammo.map(a => cleanAmmo(a)) : [], whatToBringUp: clean(o.whatToBringUp) || '', ourPick: clean(o.ourPick) || null }
          : {})
      : null,
  };
}
